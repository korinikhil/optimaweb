...
export default function Testimonials() {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-gray-100 to-gray-200 overflow-hidden">
      ...
      >
        <p className="text-gray-600 font-semibold uppercase tracking-wide">What Our Clients Say</p>
          ...
          >
            ...
            >
              <img
                ...
                className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-black shadow-md"
              />
            ...
            <div className="text-center md:text-left flex-1">
              <div className="flex justify-center md:justify-start items-center gap-1 text-yellow-400 mb-3">
                ...
                <span className="ml-2 text-black font-semibold">{testimonials[current].rating}</span>
              </div>
