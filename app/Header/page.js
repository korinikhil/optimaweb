    ...
    >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <Link href="/" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setIsOpen(false)}>Home</Link>
            <Link href="/About" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setIsOpen(false)}>About Us</Link>
            <Link href="/Service" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setIsOpen(false)}>Services</Link>
            <Link href="/Blog" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setIsOpen(false)}>Blog</Link>
            <Link href="/Contact" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setIsOpen(false)}>Contact Us</Link>
            <button
              className="w-full text-center bg-gray-800 text-white px-4 py-2 mt-2 rounded hover:bg-black transition"
